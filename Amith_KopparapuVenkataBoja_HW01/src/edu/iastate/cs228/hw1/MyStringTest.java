...
public class MyStringTest {
    ...
    // This shouldn't be the case, but it currently is (exposed private field)
    /** Ensure private field is not leaked */
    /*
    @Test
    public void test() {
        MyString s = new MyString(new char[]{'a'});
        char[] a = s.toCharArray();
        a[0] = 'b';
        assertNotEquals(s.charAt(0), a[0]);
    }
    */
}
