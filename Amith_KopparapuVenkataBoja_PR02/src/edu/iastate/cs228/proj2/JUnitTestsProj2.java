...
public class JUnitTestsProj2 {
	...
	@Test
	// Based on the sorted word lists we were given, the first letters in the list have the highest priority
	// Make sure you don't do it backwards
	...
	public void test08_SorterWithStatisticsSort() {
		...
		assertEquals(0, sorter.getTotalTimeToSortWords());
